...
export default function Manage({
  ...
  const [showStakingModal, setShowStakingModal] = useState(true)
    ...
    <PageWrapper gap="lg" justify="center">
      ...
      {stakingInfo && (
        <>
          <StakingModal
            ...
            onDismiss={() => setShowStakingModal(true)}
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
        <BottomSection gap="lg" justify="center">
          ...
          <StyledBottomCard dim={stakingInfo?.stakedAmount?.equalTo(JSBI.BigInt(0))}>
            ...
            <AutoColumn gap="sm">
              <RowBetween>
                <div>
                  <TYPE.black>Your unclaimed LYFT</TYPE.black>
                </div>
        ...
        <TYPE.main style={{ textAlign: 'center' }} fontSize={14}>
          ...
          When you withdraw, the contract will automatically claim LYFT on your behalf!
        </TYPE.main>
